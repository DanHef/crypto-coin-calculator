...
var PlatformService = (function () {
    ...
    PlatformService.prototype.createCurrencyPriceFromSymbol = function (symbolPair, platform) {
        var sourceSymbol = symbolPair.slice(0, 2);
        var targetSymbol = symbolPair.slice(3, 5);
